...
describe('Catalog Bulk Select & Edit validations', () => {
  ...
  const initialProducts: Product[] = [
    { id: 'p-101', title: 'Bosch Angle Grinder', category: 'Power Tools', subcategory: 'Grinders', price: 5000, stockStatus: 'in_stock', popularity: 80, rating: 4.5, reviewsCount: 15, imageUrl: '', description: 'Test', specifications: {} },
    { id: 'p-102', title: 'DeWalt Hammer Drill', category: 'Power Tools', subcategory: 'Drills', price: 8000, stockStatus: 'in_stock', popularity: 90, rating: 4.8, reviewsCount: 30, imageUrl: '', description: 'Test', specifications: {} },
    { id: 'p-103', title: 'Stanley Hand Wrench', category: 'Hand Tools', subcategory: 'Wrenches', price: 1200, stockStatus: 'low_stock', popularity: 70, rating: 4.2, reviewsCount: 8, imageUrl: '', description: 'Test', specifications: {} }
  ];
